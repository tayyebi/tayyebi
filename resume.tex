...
\begin{center}
    ...
    \textbf{ Software Developer • MBA • WorldSkills Champion • C\#, Linux, BI } \\ \vspace{1pt}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
        ...
        \resumeItemListStart
            ...
            \resumeItem{Developed 15\textsuperscript{+} desktop, 30\textsuperscript{+} web applications, and 3 IoT and Sensors Network utility programs.}
            \resumeItem{\href{https://kouy.ir/recommendation}{Recommended} by 10\textsuperscript{+} customers and managers with a diverse \href{https://kouy.ir/portfolio}{portfolio}.}
          \resumeItemListEnd

    \resumeSubheading
      {IT Consultant \& Web Developer}{Part-time Remote  $\bullet$ Maharashtra, India}
    ...
    \resumeSubheading
      {Guest Teacher}{$\bullet$ Hamedan, Iran}
...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Bachelor of Science in Computer Engineering, Minor in Information Technology}{September 2016 -- August 2021}
  \resumeSubHeadingListEnd
...
\section{Skills, Projects, and Technologies}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{DevOps}{: Windows Server, Debian/Ubuntu Linux, Docker} \\
     \textbf{Project Management}{: SWOT Analysis, BA, UML} \\
    }}
 \end{itemize}
