...
\section{Summary}
    \begin{itemize}[leftmargin=0.15in, label={}]
        \item\justifying
            Software Engineer with 5\textsuperscript{+} years of experience mainly focused on back-end development and business analysis. Competitive programmer, skilled with database design and server maintenance, exact in tracking and tracing projects, skilled with reporting, comfortable in collaboration with internal and external stakeholders, always ready for challenges, active learner.
            \end{itemize}
